...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Navigációs komponens megjelenítése";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Navigációs komponens elrejtése";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="Tartalomjegyzék szinkronizálása";

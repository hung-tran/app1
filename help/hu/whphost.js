	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Az összefűzött súgó "+aRProj[0].sPPath+" más nyelvű, mint a fő súgó, ami azt okozza, hogy a tárgymutató és a teljes szöveges kereső funkció le lesz tiltva az összefűzött súgóban.");
		}
		...
		alert("Nem sikerült helyesen betölteni, kattintson a Frissítés gombra.");
}

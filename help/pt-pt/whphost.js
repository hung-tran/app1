	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("O sistema de ajuda intercalado "+aRProj[0].sPPath+" está a utilizar um idioma diferente do sistema de ajuda principal, o que fará com que a funcionalidade do índice e de procura de texto completo seja desactivada no sistema de ajuda intercalado.");
		}
		...
		alert("Não foi possível carregar correctamente, clicar em Renovar.");
}

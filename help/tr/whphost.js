	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Birleşik Yardım sistemi "+aRProj[0].sPPath+" ana Yardım sisteminden farklı bir dil kullanıyor. Bu nedenle, dizin ve tam metin arama işlevi, birleşik Yardım sisteminde devre dışı bırakılacaktır.");
		}
		...
		alert("Düzgün biçimde yüklenemiyor, lütfen Yenile’ye tıklayın.");
}

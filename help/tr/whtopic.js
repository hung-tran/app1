...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Gezinme Bileşenini Göster";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Gezinme Bileşenini Gizle";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="İçindekileri Senkronize Et";

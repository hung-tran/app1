...
function addSearchForm()
{
	...
	else if("image"=="image"&&gsIGo)
	{
		...
		sButton+="<img alt=\"Git\" src=\""+gsIGo+"\" border=0 align=\"absmiddle\"></a></td>";
	}
	sButton+="</tr></table>";
	if(gbNav6)
		sButton+="</form>";
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Gezinme Bileşenini Göster";
	...
	{
		var svTitle="Gezinme Bileşenini Gizle";
	...
	{
		var svTitle="İçindekileri Senkronize Et";
	...
	{
	    var svTitle="İçerik kategorisi seçin";

	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Scalony system Pomocy "+aRProj[0].sPPath+" używa innego języka niż główny system Pomocy, co spowoduje wyłączenie funkcji indeksu i wyszukiwania pełnotekstowego w scalonym systemie Pomocy.");
		}
		...
		alert("Nie można poprawnie załadować. Kliknij przycisk Odśwież.");
}

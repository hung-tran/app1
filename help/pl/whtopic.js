...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Pokaż składnik nawigacji";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Ukryj składnik nawigacji";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="Synchronizacja spisu treści";

...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Visa navigeringselementet";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Dölj navigeringselementet";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="Synkronisera innehållsförteckningen";

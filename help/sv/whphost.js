	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Det sammanslagna hjälpsystemet "+aRProj[0].sPPath+" använder ett annat språk än huvudhjälpsystemet vilket leder till att index och funktionen för fulltextsökning inaktiveras i det sammanslagna hjälpsystemet.");
		}
		...
		alert("Kunde inte läsa datan korrekt. Klicka på Refresh.");
}

<%@ Page Language="C#" AutoEventWireup="true" Inherits="pfup.remove_user" MasterPageFile="~/header_menu.master" Codebehind="remove_user.aspx.cs" %>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="pageContent">
    <div id="divInstructions" runat="server" class="divInstructions">
	    <div class="divInstructionsLeft">
		    <p class="sectionHeader"><asp:Label ID="lblTitle" runat="server" Text="My Account:" meta:resourcekey="lblTitleResource1"></asp:Label> <span class="sectionHeaderAccent"><asp:Label ID="lblSubtitle" runat="server" Text="Remove User" meta:resourcekey="lblSubtitleResource1"></asp:Label></span></p>
		    <p>
		      <asp:Label ID="lblInstructions" runat="server" Text="Confirm permanent removal of this user." meta:resourcekey="lblInstructionsResource1"></asp:Label>
		    </p>
	    </div>

<%@ Page Language="C#" AutoEventWireup="true" Inherits="pfup.static_token" MasterPageFile="~/header_menu.master" ValidateRequest="false" Codebehind="static_token.aspx.cs" %>
...
<asp:Content ID="Content4" runat="server" ContentPlaceHolderID="pageContent">
    <div id="divInstructions" runat="server" class="divInstructions">
	    <div class="divInstructionsLeft">
		    <p class="sectionHeader"><asp:Label ID="lblTitle" runat="server" Text="Token Verification" meta:resourcekey="lblTitleResource1"></asp:Label></p>
		    <p>
		        <asp:Label ID="lblInstructions" runat="server" Text="Enter your token to complete your log in." meta:resourcekey="lblInstructionsResource1"></asp:Label>
		    </p>
	    </div>
    ...
    <asp:Panel ID="pnlDisable" runat="server" meta:resourcekey="pnlDisableResource1">
		<h5><asp:Label ID="lblToken" runat="server" Text="Token" meta:resourcekey="lblTokenResource1"></asp:Label></h5>
		<asp:TextBox ID="txtToken" runat="server" Width="125px" TextMode="Password" meta:resourcekey="txtTokenResource1" />
